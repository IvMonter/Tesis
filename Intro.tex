...
Sea $U$ un conjunto acotado, convexo y abierto en $\mathbb{R}^n$. Sea $f$ una función continua de Bd $U$ en $X$. Entonces \mm{f} puede extenderse continuamente a una función de $\bar{U}$ en X.
\end{Teo}
% Local Variables:
