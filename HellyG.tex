...
Así $f$ cumple que los puntos $f(\sigma_0),\ldots,f(\sigma_n)$ pertenen al simplejo $\sigma_{n}$ y por el teorema \ref{tms} puede extenderse a un mapa continua $g\colon \abs{\sd\Delta}\rightarrow\abs{\Delta}$ tal que:
\begin{equation*}
