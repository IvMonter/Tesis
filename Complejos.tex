...
Un complejo simplicial abstracto es una colección $\mathcal{S}$ de conjuntos no vacíos tales que si $A$ está en $\mathcal{S}$, todo subconjunto no vacío de $A$ también lo está. Un elemento $\textit{A}$ $\mathcal{S}$ es llamado un simplejo se $\mathcal{S}$. 
\end{Defi}
